...
The original design is available at [Anonymised]
...
- **Research Context**: Anonymised information
...
3. **Configure build settings**
   - **Project name**: `your-reading-comprehension-app` (or your preferred name)
...
2. **Deploy via Cloudflare Dashboard**
   ...
   - Name your project (e.g., `your-reading-comprehension-app`)
...
3. **Build and deploy**
   ```bash
   npm run build
   wrangler pages deploy dist --project-name=your-reading-comprehension-app
   ```
