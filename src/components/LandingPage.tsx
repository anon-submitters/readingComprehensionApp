      ...
      <div className="mobile-warning-overlay">
        <div className="mobile-warning-modal">
          ...
          <div className="mobile-warning-footer">
            <p>Anonymised information • Anonymised information</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="flex flex-col">
          <form id="user-info-form" onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="text-xs text-gray-500">
              Project authors: Anonymous.<br></br>Questions? <a href="mailto:anon@anonymized.org" className="text-blue-600 hover:underline">anon@anonymized.org</a> | <a href="https://www.google.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Course Info</a>
            </div>
          </form>
        </div>
        ...
        <div className="flex flex-col">
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500">
              Anonymised information • Anonymised information
            </p>
          </div>
